...
public class HttpClientUtils {
	...
	public static String postJson(String apiUrl) throws ConnectTimeoutException, SocketTimeoutException, Exception {
		return post(apiUrl, null, "application/json", charset, connTimeout, readTimeout);
	}
