...
public class CodeGenerator {
	...
	private static final String JDBC_URL = "jdbc:mysql://39.104.20.2:3306/yeetong_todo?useSSL=false";
	private static final String JDBC_USERNAME = "wisdom_root";
	private static final String JDBC_PASSWORD = "JIwLi5j40SY#o1Et";
	...
	private static final String AUTHOR = "Yeetong.CN";// @author
...
//		genCodeByCustomModelName("td_user_like", "TdUserLike", "yt");
	...
	public static void genModelAndMapper(String tableName, String modelName, String db) {
		...
		javaClientGeneratorConfiguration.setTargetPackage(MAPPER_PACKAGE + "." + db);
